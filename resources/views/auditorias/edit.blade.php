...
@section('content')
    ...
    <div id="contenedorFullPreguntas" class="container-fluid mt--6">
        <form id="auditoriasform" action="{{ route('auditorias.update',$diagnostico->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="col-xl-12 bg-white rounded mb-4 card ">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="nombre_grupo" name="nombre_grupo" class="form-control"
                                    placeholder="Ejemplo: Prueba Piloto para Alena" required value="{{ $diagnostico->nombre_grupo }}" >
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" id="descripcion_grupo" name="descripcion_grupo" class="form-control"
                                    placeholder="Pruebas de Diagnosticos que se realizaron en la empresa Alena " required value="{{ $diagnostico->descripcion_grupo }}" >
                ...
                <div class=" p-2 mr-2">
                        ...
                        <div class="pl-lg-4">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nombre_empresa" name="nombre_empresa" class="form-control"
                                            placeholder="Ingrese El Nombre de la Empresa" required value="{{ $diagnostico->nombre_empresa }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nit_empresa" name="nit_empresa" class="form-control"
                                            placeholder="Ingrese El NIT de la empresa" required value="{{ $diagnostico->nit_empresa }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" id="correo_empresa" name="correo_empresa" class="form-control"
                                            placeholder="Correo Electronito Coorporativo" required value="{{ $diagnostico->correo_empresa }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="direccion_empresa" name="direccion_empresa" class="form-control"
                                            placeholder="Ingrese la Direccion"  value="{{ $diagnostico->direccion_empresa }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="direccion_empresa2" name="direccion_empresa2" class="form-control"
                                            placeholder="Ingrese la Direccion"  value="{{ $diagnostico->direccion_empresa2 }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="telefono_fijo" name="telefono_fijo" class="form-control"
                                            placeholder="Ingrese El Telefono" value="{{ $diagnostico->telefono_fijo }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="telefono_celular" name="telefono_celular" class="form-control"
                                            placeholder="Ingrese El Celular Corporativo"  value="{{ $diagnostico->telefono_celular }}" >
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nombre_oficial_cumplimiento" name="nombre_oficial_cumplimiento" class="form-control"
                                            placeholder="Ingrese El Nombre del Oficial de Cumplimiento" required value="{{ $diagnostico->nombre_oficial_cumplimiento }}" >
                            ...
                            <button type="submit" id="btnCrearActividad" class="btn btn-info mb-2">Editar Grupo</button>
                        </div>
                    </form>
                </div>
            </div>
