            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    <div class="col-lg-6 col-7">
                        <h3 class="h2 text-white d-inline-block mb-0">Mi Dashboard</h3>
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}"><i class="fas fa-home"></i></a></li>
                                <li class="breadcrumb-item active" aria-current="page">Mi Panel de Control</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('proyectos.index') }}" class="btn btn-sm btn-neutral">
    ...
    <div class="container-fluid mt--6">
        ...
        <div class="row mb-4">
            <div class="col-xl-3 col-md-6">
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase text-muted mb-0">Mis Proyectos</h5>
                        <span class="h2 font-weight-bold mb-0">{{ $totalProyectos }}</span>
                    </div>
                    <div class="card-footer bg-transparent">
                        <span class="text-primary mr-2">
                            <i class="fas fa-folder"></i>
                        </span>
                        <span class="text-nowrap text-muted text-sm">Proyectos Activos</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        ...
                        <span class="h2 font-weight-bold mb-0">{{ $proyectosFinalizados }}</span>
                    </div>
                    <div class="card-footer bg-transparent">
                        <span class="text-success mr-2">
                            <i class="fas fa-check-circle"></i>
                        </span>
                        <span class="text-nowrap text-muted text-sm">{{ round(($proyectosFinalizados / max($totalProyectos, 1)) * 100, 1) }}% completados</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase text-muted mb-0">En Curso</h5>
                        <span class="h2 font-weight-bold mb-0">{{ $proyectosEnCurso }}</span>
                    </div>
                    <div class="card-footer bg-transparent">
                        <span class="text-warning mr-2">
                            <i class="fas fa-spinner fa-spin"></i>
                        </span>
                        <span class="text-nowrap text-muted text-sm">En progreso</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        ...
                        <span class="h2 font-weight-bold mb-0">{{ $proyectosPendientes }}</span>
                    </div>
                    <div class="card-footer bg-transparent">
                        <span class="text-danger mr-2">
                            <i class="fas fa-hourglass-start"></i>
                        </span>
                        <span class="text-nowrap text-muted text-sm">Sin iniciar</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-xl-3 col-md-6">
                <div class="card border-left-primary">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase text-muted mb-0">Mis Actividades</h5>
                        <span class="h2 font-weight-bold mb-0 text-primary">{{ $totalActividades }}</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card border-left-success">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase text-muted mb-0">Completadas</h5>
                        <span class="h2 font-weight-bold mb-0 text-success">{{ $actividadesFinalizadas }}</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card border-left-warning">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase text-muted mb-0">En Curso</h5>
                        <span class="h2 font-weight-bold mb-0 text-warning">{{ $actividadesEnCurso }}</span>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-md-6">
                <div class="card border-left-danger">
                    <div class="card-body">
                        <h5 class="card-title text-uppercase text-muted mb-0">Pendientes</h5>
                        <span class="h2 font-weight-bold mb-0 text-danger">{{ $actividadesPendientes }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Mi Avance en Proyectos</h3>
                    </div>
                    <div class="card-body">
                        <div class="progress" style="height: 25px;">
                            <div class="progress-bar bg-primary" role="progressbar" style="width: {{ $promedioAvanceProyectos }}%;" aria-valuenow="{{ $promedioAvanceProyectos }}" aria-valuemin="0" aria-valuemax="100">
                                <strong>{{ round($promedioAvanceProyectos, 1) }}%</strong>
                            </div>
                        </div>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Mi Avance en Actividades</h3>
                    </div>
                    <div class="card-body">
                        <div class="progress" style="height: 25px;">
                            <div class="progress-bar bg-info" role="progressbar" style="width: {{ $promedioAvanceActividades }}%;" aria-valuenow="{{ $promedioAvanceActividades }}" aria-valuemin="0" aria-valuemax="100">
                                <strong>{{ round($promedioAvanceActividades, 1) }}%</strong>
                            </div>
                        </div>
                        <p class="mt-3 text-muted text-sm">
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header border-0 d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Mis Proyectos Destacados</h3>
                        <a href="{{ route('proyectos.index') }}" class="btn btn-sm btn-info">
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody class="list">
                                @forelse($proyectosDestacados as $proyecto)
                                    <tr>
                                        <td>
                                            <a href="{{ route('proyectos.actividades', $proyecto->id) }}" class="text-primary font-weight-bold">
                                                {{ $proyecto->nombre }}
                                            </a>
                                        </td>
                                        <td>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header border-0 d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Actividades Próximas</h3>
                        <span class="badge badge-warning">{{ count($actividadesProximas) }}</span>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush table-sm">
                            ...
                            <tbody class="list">
                                @forelse($actividadesProximas as $actividad)
                                    <tr>
                                        <td class="text-truncate">
                                            <a href="{{ route('actividades.edit', $actividad->id) }}" class="text-primary font-weight-bold">
                                                {{ $actividad->nombre }}
                                            </a>
                                        </td>
                                        <td>
        ...
        <div class="row mt-4">
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Actividades con Bajo Avance</h3>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                            ...
                            <tbody class="list">
                                @forelse($actividadesBajoAvance as $actividad)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-warning">{{ $actividad->proyectos->nombre }}</span>
                                        </td>
                                        <td>
                                            <div class="progress" style="width: 100px;">
                                                <div class="progress-bar bg-danger" role="progressbar" style="width: {{ $actividad->avance }}%;">
                                                    {{ $actividad->avance }}%
                                                </div>
                                            </div>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-4">
                                            ¡Excelente! No tienes actividades con bajo avance
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-header border-0">
                        <h3 class="mb-0">Mis Proyectos por Área</h3>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            <thead class="thead-light">
                            ...
                            <tbody class="list">
                                @forelse($proyectosPorArea as $area)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="progress" style="width: 80px; height: 6px;">
                                                <div class="progress-bar bg-info" role="progressbar" style="width: {{ ($area->total / max($totalProyectos, 1)) * 100 }}%;"></div>
                                            </div>
                                        </td>
                                    </tr>
                                @empty
