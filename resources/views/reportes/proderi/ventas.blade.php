...
@section('content')
                    ...
                    <div class="col-8">
                        ...
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item text-dark active" aria-current="page">Ventas</li>
                            </ol>
                        </nav>
                    ...
                    <div class="col-4">
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item mr-2 mr-md-0">
                                <a href="{{ route('proderiIndex') }}" class="btn btn-transparent py-2 px-3">
    ...
    <div id="contenedorFullPreguntas" class="container-fluid mt--6">
        <div class="row">
            <div class="col-xl-12">
                <iframe title="Operaciones" class="rounded" width="100%" height="720" src="https://app.powerbi.com/view?r=eyJrIjoiZTRlNTdjZTgtZmEwMi00MDYwLWJiN2YtMDc3ZWJmNjJlMDlmIiwidCI6ImE3MDViNGI5LWE3Y2UtNDA3YS04YTdlLTY0NThlYjVkZDQxNiJ9"
