...
@section('content')
                    ...
                    <div class="col-8">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                            <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                                ...
                                <li class="breadcrumb-item text-dark active" aria-current="page">Acoficum</li>
                            </ol>
                        </nav>
    ...
    <div id="contenedorFullPreguntas" class="container-fluid mt--6">
        <div class="row">
            <div class="col-xl-12">
                <iframe title="proderi general" class="rounded" width="100%" height="720" src="https://app.powerbi.com/view?r=eyJrIjoiZDVmMzQ4NzQtNDA4ZS00ZGJiLTk4YzktODFjNWY2NjJmZDFjIiwidCI6ImE3MDViNGI5LWE3Y2UtNDA3YS04YTdlLTY0NThlYjVkZDQxNiJ9"frameborder="0" allowFullScreen="true"></iframe>
            </div>
        </div>
    </div>
    @endsection
